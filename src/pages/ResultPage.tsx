...
import { Container, Typography, Box, CircularProgress, Tabs, Tab, IconButton, Grid, Card, CardContent, TextField, InputAdornment, GridProps, Button, Collapse, useTheme, useMediaQuery, GlobalStyles } from '@mui/material';
